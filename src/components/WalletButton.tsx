...
/**
 * Wallet button — the proven RainbowKit ConnectButton.Custom (see
 * WALLET_CONNECT.md). RainbowKit's modal handles wallet discovery, mobile
 * WalletConnect, and network switching, so multi-chain wallets connect on the
 * EVM/Robinhood network instead of defaulting to Solana.
 *
