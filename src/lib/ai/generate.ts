...
/**
 * Pork's launch-package generator.
 *
...
const CREATIVE_RULES = `You are the creative engine of Pork, a cinematic AI launchpad for the Pons protocol on Robinhood Chain.
