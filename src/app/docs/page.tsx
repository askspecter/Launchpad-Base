  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-zinc-600">
        <section>
          <h2 className="font-display text-lg font-semibold text-zinc-900">One sentence, one token</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-lg font-semibold text-zinc-900">Launch models</h2>
          <ul className="mt-2 space-y-2">
            <li>
              <span className="text-zinc-900">v1 — Instant Pool.</span> One transaction deploys the token
              and a Uniswap V3 pool (WETH), locked immediately. Tradable at launch. Open to everyone.
            </li>
            <li>
              <span className="text-zinc-900">v2 — Bonding Curve.</span> A fair launch on a bonding curve
        ...
        <section>
          <h2 className="font-display text-lg font-semibold text-zinc-900">Non-custodial</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-lg font-semibold text-zinc-900">Get started</h2>
          <p className="mt-2">
            Head to{" "}
