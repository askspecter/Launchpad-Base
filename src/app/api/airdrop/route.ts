 ...
 * uploaded to KV as a hash `pork:airdrop` of { addressLowercase: amount }, with
 * a `pork:airdrop:live` flag flipped on once it is final. Until then the page
 * shows "snapshot pending" - we never fabricate an allocation.
 */
const HASH = "pork:airdrop";
const LIVE = "pork:airdrop:live";
