...
export default function PrivacyPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <h1 className="mt-3 font-display text-4xl font-bold text-white">Privacy Policy</h1>
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-zinc-400">
        ...
        <section>
          <h2 className="font-display text-lg font-semibold text-white">What we process</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-lg font-semibold text-white">What we do not do</h2>
          <p className="mt-2">
